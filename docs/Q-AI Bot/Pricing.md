...
The Q-AI Bot is billed by the number of **conversations** the assistant handles each month, on a **tier** set by the project's [message limit](/docs/q-ai-bot/per-project-settings).
