...
| `chat`       | Chat-level operations                | `labels`, `externalBot`, `sensitiveSession`, `updateCrmData`, `setDisplayName`                                                                                                                                                                                              |
| `utils`      | Utility functions                    | `randomCode`, `matchValues`                                                                                                                                                                                  |
| `dataStorage` | Customer-scoped keyed JSON store (TTL, tags) | `get`, `set`, `list`, `delete` — see [Data Storage overview](./Types/Func/Data%20Storage/Overview) |
